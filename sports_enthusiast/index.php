   ...
   <aside id="logo-sidebar" class="fixed top-0  z-40 w-64 h-[87vh] pt-20 transition-transform -translate-x-full bg-white border-r sm:translate-x-0" aria-label="Sidebar">
      <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
         <ul class="space-y-2 text-sm">
            ...
            <li>
               <a href="/komunitas/akomunitas.html" class="flex items-center p-2 text-black rounded-lg hover:bg-red-700 hover:text-white group">
                  <i class="fi fi-rs-users-alt"></i>
                  <span class="flex-1 ms-3 whitespace-nowrap">Add Community</span>
               </a>
            </li>
            <li>
               <a href="<?=$base_url?>/sports_enthusiast/field/" class="flex items-center p-2 text-black rounded-lg hover:bg-red-700 hover:text-white group">
   ...
   <main class="pt-20 pb-20">
      <div class="flex justify-end">
         ...
         <div class="lg:w-3/5 md:w-3/5 p-4 ">  
            ...
            <div class="flex mb-4">
               <div id="default-carousel" class="relative w-full" data-carousel="slide">
                  <!-- Carousel wrapper -->
                  <div class="relative h-60 overflow-hidden rounded-l-lg md:h-75">
                     <!-- Item 1 -->
               ...
               <div class="w-1/3 h-60 bg-red-700 text-white flex items-center justify-center rounded-r-lg">
         ...
         <script>
            ...
            <div class="bg-white p-4 rounded-lg shadow mb-4">
               <div class="flex items-center mb-4">
                  <img alt="User Profile" class="rounded-full w-12 h-12" height="40" src="/image/running.jpg" width="40"/>
                  <div>
                     <p class="font-bold">Rina</p>
                     <p class="text-gray-500 text-sm">Kemarin 9.00 AM</p>
                  </div>
               </div>
               <p class="mb-4">Seru-seruan di taman kota!</p>
               <img alt="Playing Basketball" class="w-full rounded-lg" height="300" src="/image/running.jpg" width="600"/>
            </div>

            <!-- Post 3 -->
            <div class="bg-white p-4 rounded-lg shadow mb-4">
               <div class="flex items-center mb-4">
                  <img alt="User Profile" class="rounded-full w-12 h-12" height="40" src="/image/basketball.jpg" width="40"/>
                  <div>
                     <p class="font-bold">Agus</p>
                     <p class="text-gray-500 text-sm">Kemarin 7.30 PM</p>
                  </div>
               </div>
               <p class="mb-4">Bermain futsal bersama teman-teman!</p>
               <img alt="Futsal Game" class="w-full rounded-lg" height="300" src="/image/basketball.jpg" width="600"/>
            </div>
         </div>
